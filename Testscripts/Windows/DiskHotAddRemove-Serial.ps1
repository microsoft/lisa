...
function Main {
    ...
    try {
        ...
        While ($count -lt $diskCount) {
            ...
            $sts1 = Add-AzVMDataDisk -VM $VirtualMachine -Name $diskName -CreateOption Attach -ManagedDiskId $dataDisk.Id -Lun $count
            ...
            $sts3 = Remove-AzVMDataDisk -VM $VirtualMachine -DataDiskNames $diskName
