...
function Main {
    ...
    try {
        ...
        $kvpStatus = Run-LinuxCmd -username "root" -password $password -ip $AllVMData.PublicIP -port $AllVMData.SSHPort -command "pgrep -lf 'hypervkvpd|hv_kvp_daemon'" -ignoreLinuxExitCode
