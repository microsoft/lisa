...
Function Check-modules() {
    ...
    Copy-RemoteFiles -download -downloadFrom $allVMData.PublicIP -files "/home/$user/state.txt,/home/${user}/${remoteScript}.log" -downloadTo $LogDir -port $allVMData.SSHPort -username $user -password $password
