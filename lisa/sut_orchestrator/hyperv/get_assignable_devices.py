...
class HypervAssignableDevices:
    ...
    PKEY_REQUIRES_RESERVED_MEMORY_REGION = (
        "{3AB22E31-8264-4b4e-9AF5-A8D2D8E33E62}  34"  # noqa E501
    )
    PKEY_ACS_COMPATIBLE_UP_HIERARCHY = (
        "{3AB22E31-8264-4b4e-9AF5-A8D2D8E33E62}  31"  # noqa E501
    )
