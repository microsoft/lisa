...
class KernelConfig(Tool):
    """
    KernelConfig is a tool that can check module exists or not, module is built-in or
     built as module.
    """
    ...
    def is_driver_built_in(self, config_name: str) -> bool:
        return (
            self.node.execute(
    ...
    def is_driver_built_as_module(self, config_name: str) -> bool:
        return (
            self.node.execute(
    ...
    def is_driver_enabled(self, config_name: str) -> bool:
        return self.is_driver_built_as_module(config_name) or self.is_driver_built_in(
            config_name
        )
