...
class Free(Tool):
    ...
    _byte_size_flags = {"KiB": "-k", "MiB": "-m", "GiB": "-g"}
    ...
    def _get_field(
        self, field_name: str, header_name: str, byte_size: str = "MiB"
    ) -> int:
        ...
        # fetch the flag for the data format we want
        byte_size_flag = self._byte_size_flags[byte_size]

        # get the data
        out = self.run(byte_size_flag, force_run=True).stdout
    ...
    def get_swap_size(self) -> int:
        ...
        return self._get_field("Swap", "total", "MiB")

    def get_free_memory_mb(self) -> int:
        return self._get_field("Mem", "free", "MiB")

    def get_free_memory_gb(self) -> int:
        return self._get_field("Mem", "free", "GiB")
