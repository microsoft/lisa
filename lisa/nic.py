...
class Nics(InitializableMixin):
    ...
    def get_accelerated_networking_drivers(self) -> List[str]:
        """Return the MANA or Mellanox accelerated networking drivers.
        ...
        for pci_device in pci_devices:
            driver = lspci.get_accelerated_networking_device_module(pci_device)
