...
class Virtualization(Feature):
    ...
    - CloudHypervisor: Cloud-native hypervisor
    - QEMU: QEMU/KVM virtualization stack
    - VMware: VMware vSphere/ESXi hypervisor
    - Xen: Xen hypervisor
    - None: Unknown or undetected virtualization (default)
...
BareMetalHostType = _host_type_requirement(schema.VirtualizationHostType.BareMetal)
HyperVHostType = _host_type_requirement(schema.VirtualizationHostType.HyperV)
CloudHypervisorHostType = _host_type_requirement(
    schema.VirtualizationHostType.CloudHypervisor
)
QemuHostType = _host_type_requirement(schema.VirtualizationHostType.QEMU)
VMwareHostType = _host_type_requirement(schema.VirtualizationHostType.VMware)
XenHostType = _host_type_requirement(schema.VirtualizationHostType.Xen)
