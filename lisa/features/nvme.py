...
class Nvme(Feature):
    ...
    def get_raw_nvme_disks(self) -> List[str]:
        ...
        # With disk controller type NVMe, the OS partition shows up as an NVMe disk
        # so we need to remove it from the list of namespaces as this is not an actual NVMe disk
