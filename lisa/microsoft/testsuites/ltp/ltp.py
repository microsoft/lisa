...
class Ltp(Tool):
    ...
    LTP_DIR_NAME = "ltp"
    # Bumped to 20260130 to fix listmount04.c build failure on newer kernels
    # ('struct mnt_id_req' no longer has a 'spare' member). Fixed upstream
    # after the 20250130 tag.
