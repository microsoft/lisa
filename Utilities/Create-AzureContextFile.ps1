# Remove the saved contexts from current PS session to avoid unauthorised export of saved contexts.
...
Write-Host "--------------------------------------------------------------------------------------------"
Write-Host "DO NOT SHARE THIS FILE WITH ANYONE TO AVOID UNAUTHORISED ACCESS TO YOUR AZURE SUBSCRIPTIONS."
Write-Host "--------------------------------------------------------------------------------------------"
