...
4. You download 3rd party software in Tools folder. If you are using Azure blob in Storage account, you can add a tag <blobStorageLocation></blobStorageLocation> in AzureSecret.xml file.
* 7za.exe
* dos2unix.exe
* gawk
* jq
