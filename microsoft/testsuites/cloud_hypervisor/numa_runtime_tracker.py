...
class NumaRuntimeTracker:
    ...
    def get_summary(self, numa_config: Optional[Dict] = None) -> TestSummary:
        ...
        summary = TestSummary(
            ...
            irq_locality_enabled=self.numa_config.get("irq_affinity", {}).get("enabled"),
    ...
    def compare_with_baseline(
        ...
        mean_delta_pct = ((current_mean - baseline_mean) / baseline_mean * 100) if baseline_mean > 0 else 0
        cv_delta_pct = ((current_cv - baseline_cv) / baseline_cv * 100) if baseline_cv > 0 else 0
        ...
        comparison = {
            ...
            "cv_absolute_delta": round(cv_absolute_delta, 2),
            "improved": improved,
            "regressed": regressed,
    ...
    def print_comparison(self, baseline_file: Path) -> None:
        ...
        print(f"   Δ Mean:              {comparison['mean_delta_pct']:+.2f}%")
        ...
        cv_abs_delta = comparison['cv_absolute_delta']
        print(f"   Δ CV% (absolute):    {cv_abs_delta:+.2f}%")
