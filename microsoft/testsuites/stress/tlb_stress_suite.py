...
class TlbStressTestSuite(TestSuite):
    ...
    def tlb_stress_basic(
        ...
        log.info("Starting basic TLB stress test...")
        ...
        try:
            ...
            log.info("Running guest workload probe to establish baseline...")
            stress_ng.run(
    ...
    def tlb_stress_stressng(
        ...
        log.info("Starting comprehensive TLB stress test with performance monitoring")
        ...
        try:
            ...
            log.info("Phase 1: Capturing baseline performance metrics...")
            ...
            log.info("Waiting for TLB stressor and combined stress-ng to complete...")
