...
from microsoft.testsuites.kdump.kdumputils import KdumpUtils
...
class KdumpCrash(TestSuite):
    ...
    def verify_kdumpcrash_single_core(
        ...
        self.kdump_util._kdump_test(node, log_path, log)
    ...
    def verify_kdumpcrash_smp(self, node: Node, log_path: Path, log: Logger) -> None:
        self.kdump_util._trigger_kdump_on_specified_cpu(1, node, log_path, log)
    ...
    def verify_kdumpcrash_on_random_cpu(
        ...
        self.kdump_util._trigger_kdump_on_specified_cpu(cpu_num, node, log_path, log)
    ...
    def verify_kdumpcrash_on_cpu32(
        ...
        self.kdump_util._trigger_kdump_on_specified_cpu(32, node, log_path, log)
    ...
    def verify_kdumpcrash_on_cpu192(
        ...
        self.kdump_util._trigger_kdump_on_specified_cpu(192, node, log_path, log)
    ...
    def verify_kdumpcrash_on_cpu415(
        ...
        self.kdump_util._trigger_kdump_on_specified_cpu(415, node, log_path, log)
    ...
    def verify_kdumpcrash_auto_size(
        ...
        self.kdump_util._kdump_test(node, log_path, log, is_auto=True)
