...
class StoragePerformance(TestSuite):
    ...
    def perf_hdd_datadisks_4k(self, node: Node, result: TestResult) -> None:
    ...
    def perf_hdd_datadisks_1024k(self, node: Node, result: TestResult) -> None:
    ...
    @TestCaseMetadata(
        ...
        requirement=simple_requirement(
            disk=schema.DiskOptionSettings(
                ...
                data_disk_iops=search_space.IntRange(min=4000),
                data_disk_count=search_space.IntRange(min=16),
            ),
        ),
    )
    ...
    def perf_ssd_datadisks_1024k(self, node: Node, result: TestResult) -> None:
        self._perf_premium_datadisks(node, result, block_size=1024)
