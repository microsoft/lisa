...
class DpdkTestpmd(Tool):
    ...
    def _generate_testpmd_command(self, nic_to_include: str, command_type: str) -> str:
        #   testpmd \
        #   -l <core-list> \
        ...
        return (
            ...
            + f"{nic_to_include} -- --forward-mode={command_type} -a --stats-period 1"
        )

    def run_with_timeout(self, cmd: str, timeout: int) -> str:
