...
def verify_dpdk_l3fwd_ntttcp_tcp(
    ...
    include_devices = [
        fwd_kit.testpmd.generate_testpmd_include(subnet_a_nics[forwarder], dpdk_port_a),
        fwd_kit.testpmd.generate_testpmd_include(subnet_b_nics[forwarder], dpdk_port_b),
    ]
